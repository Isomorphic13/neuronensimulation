...
def runge_kutta_method(x_0 : np.ndarray, t_a : float, t_b : float, dt : float, I, tuple_of_constants : tuple[float]) -> np.ndarray:
    '''
    ...
    for t in t_points:
        ...
        k1 = dt * eq.equations_vector(x=x, I=I, tuple_of_constants=tuple_of_constants)

        k2 = dt * eq.equations_vector(x=x + k1 / 2, I=I, tuple_of_constants=tuple_of_constants)

        k3 = dt * eq.equations_vector(x=x + k2 / 2, I=I, tuple_of_constants=tuple_of_constants)

        k4 = dt * eq.equations_vector(x=x + k3, I=I, tuple_of_constants=tuple_of_constants)
